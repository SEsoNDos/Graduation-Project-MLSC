...
1. **Absolute Magnitude:** The brightness of the NEO.
2. **Estimated Diameter:** The minimum and maximum estimated diameter of the NEO.
3. **Relative Velocity:** The velocity of the NEO relative to Earth.
4. **Miss Distance:** The distance by which the NEO missed Earth.
5. **Orbiting Body:** The celestial body that the NEO is orbiting.
6. **Is Hazardous:** The target variable indicating whether the NEO is hazardous (1) or not (0).
...
1. Install the required dependencies:
   ...
   ```
2. Open the Jupyter Notebook to preprocess the data, train the model, and evaluate its performance.
